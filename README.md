...
## Environments
- Preview: https://main--itc-bnatural--aemysites.aem.page/
- Live: https://main--itc-bnatural--aemysites.aem.live/
- Block Library: https://main--itc-bnatural--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-bnatural` directory in your favorite IDE and start coding :)
